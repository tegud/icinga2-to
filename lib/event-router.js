...
module.exports = function(app, config) {
    ...
    function filter(routeFilter, event) {
        ...
        logging.logInfo('Event matches filter', { host: event.data.host.name, service: event.data.service.name, status: event.data.state.status, statusType: event.data.state.status, attempt: event.data.state.attempt, filter: routeFilter });

    ...
    return {
        start: () => new Promise(resolve => {
            parser.onValue = function(value) {
                ...
                const parsedData = parseStatusChange(value);

                logging.logInfo('Icinga Event Recieved', { host: parsedData.host.name, service: parsedData.service.name, checkStatus: parsedData.state.status, checkStatusType: parsedData.state.status, checkAttempt: parsedData.state.attempt });

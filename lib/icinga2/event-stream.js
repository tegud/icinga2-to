    ...
    return {
        start: () => new Promise(resolve => {
            parser.onValue = function(value) {
                ...
                logging.logInfo('Icinga Event Recieved', { host: parsedData.host.name, service: parsedData.service.name, status: parsedData.state.status, statusType: parsedData.state.status, attempt: parsedData.state.attempt });
